	...
	<!-- breadcrumb start-->
      ...
      <div>
         <div style="height: 50px;"></div>
          ...
          <div style="height: 50px;"></div>
         <div class="div1">
             Pick up a date and year to check audit:    &nbsp;
             <span style="font-size: 20px;"><input type="date" name="dt"></span>
          <input class="check2" name="submit" value="submit" type="submit">
          </div>
          </form>
           <%
              String t="";
           t=request.getParameter("dt");
           p=request.getParameter("submit");
          if(p.equals("submit"))
          {
              response.sendRedirect("Manager_d.jsp?manager_id="+t);
          }}
          catch(Exception e)
            {out.println(e);}
          %>
