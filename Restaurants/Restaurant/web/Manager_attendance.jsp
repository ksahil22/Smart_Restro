...
<%
        Query="select * from attendance natural join chef where chef.chef_id=attendance.id and logout_date is null";
        rs=stmt.executeQuery(Query);
        while(rs.next())
        {
            id=rs.getString("id");
...
<%
        Query="select * from attendance natural join waiter where waiter.waiter_id=attendance.id and logout_date is null";
        rs=stmt.executeQuery(Query);
        while(rs.next())
        {
            id=rs.getString("id");
...
<%
        Query="select * from attendance natural join cashier where cashier.cashier_id=attendance.id and logout_date is null";
        rs=stmt.executeQuery(Query);
        while(rs.next())
        {
            id=rs.getString("id");
            na=rs.getString("cashier_name");
%>
                <tr>
                 <th ><%out.println(id);%></th>
                <th><%out.println(na);%></th>
