...
%>            
              <tr>
                  <th><%out.println(i+1);%></th>
                   ...
                   <th><%out.println(m);%></th>
                   <th  style="width: 150px;"><a href="<%="Waiter_ready.jsp?order="+rs.getInt("srno")%>" style="font-family: sans-serif;
                    font-size: 20px;
                    background-color: aquamarine;
                    height: 30px;
                    width: 200px;
...
%>
 <div style="text-align: right; margin-right: 200px;">
          <a href="<%="Waiter_pause.jsp?waiter_id="+waiter_id+"$2"%>" style=" text-color:black; background-color: coral; font-family: sans-serif; font-size: 30px;">Logout</a>
      </div>
<%
} 
catch (Exception e) {
